...
// @ts-nocheck — skipped: requires vitest (vi.hoisted, vi.mock, vi.importActual)
...
// Skipped: uses vi.hoisted, vi.mock, vi.importActual which have no bun:test equivalent
describe.skip("ensureMediaHosted (requires vitest)", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
